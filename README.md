...
```
add_header Content-Security-Policy "default-src 'self' data: blob:; style-src 'self' https://cdn.jsdelivr.net https://ctalvio.github.io https://fonts.googleapis.com 'unsafe-inline'; font-src 'self' https://fonts.gstatic.com https://cdn.jsdelivr.net https://ctalvio.github.io; script-src 'self' 'unsafe-inline' https://www.gstatic.com; img-src 'self' data: https:; worker-src 'self' blob:; connect-src 'self'; object-src 'none'; base-uri 'self'; frame-ancestors 'self'";
```
